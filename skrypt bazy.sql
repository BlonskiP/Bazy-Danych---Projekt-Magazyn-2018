...
values (42, 21465, 'London', 'HelloThere', 4, '547632819');
	...
	---- CONSTRAINTS BUDYNKI
	ALTER TABLE BUDYNKI ADD CONSTRAINT fk_idDaneKontaktowe
	FOREIGN KEY (idDaneKontaktowe) REFERENCES DANEKONTAKTOWE(idDaneKontaktowe);
	ALTER TABLE BUDYNKI ADD CONSTRAINT fk_idKierownika
	FOREIGN KEY (idKierownika) REFERENCES PRACOWNICY(idPracownika);

	--- CONSTRAINTS PRACOWNICY
	ALTER TABLE PRACOWNICY ADD CONSTRAINT fk_idStanowiska
	FOREIGN KEY (idStanowiska) REFERENCES STANOWISKA(idStanowiska);
	ALTER TABLE PRACOWNICY ADD CONSTRAINT fk_idBudynku
	FOREIGN KEY (idBudynku) REFERENCES BUDYNKI(idBudynku);
	ALTER TABLE PRACOWNICY ADD CONSTRAINT fk_idDaneKontaktowe
	FOREIGN KEY (idDaneKontaktowe) REFERENCES DANEKONTAKTOWE(idDaneKontaktowe);

	--- CONSTRAINTS DOSTAWY
	ALTER TABLE DOSTAWY ADD CONSTRAINT fk_idPracownika
	FOREIGN KEY (idDostawy) REFERENCES PRACOWNICY(idPracownika);
	ALTER TABLE DOSTAWY ADD CONSTRAINT fk_idProduktu
	FOREIGN KEY (idProduktu) REFERENCES PRODUKTY(idProduktu);
	--- CONSTRAINTS PRODUCENCI
	ALTER TABLE PRODUCENCI ADD CONSTRAINT fk_idDaneKontaktowe
	FOREIGN KEY (idDaneKontaktowe) REFERENCES DANEKONTAKTOWE(idDaneKontaktowe);

	--- CONSTRAINTS KLIENCI
	ALTER TABLE KLIENCI ADD CONSTRAINT fk_idDaneKontaktowe
	FOREIGN KEY (idDaneKontaktowe) REFERENCES DANEKONTAKTOWE(idDaneKontaktowe);

	---CONSTRAINTS ZAMOWIENIA
	ALTER TABLE ZAMOWIENIA ADD CONSTRAINT fk_idKlienta
	FOREIGN KEY (idKlienta) REFERENCES KLIENCI(idKlienta);
	ALTER TABLE ZAMOWIENIA ADD CONSTRAINT fk_idProduktu
	FOREIGN KEY (idProduktu) REFERENCES PRODUKTY(idProduktu);
	ALTER TABLE ZAMOWIENIA ADD CONSTRAINT fk_idPracownika
	FOREIGN KEY (idPracownika) REFERENCES PRACOWNICY(idPracownika);

	---CONSTRAINTS PRODUKTY
	ALTER TABLE PRODUKTY ADD CONSTRAINT fk_idBudynku
	FOREIGN KEY (idBudynku) REFERENCES BUDYNKI(idBudynku);
	ALTER TABLE PRODUKTY ADD CONSTRAINT fk_idProducenta
