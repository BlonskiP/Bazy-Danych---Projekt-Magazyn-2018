	...
	(
		...
		id_DaneKontaktowe NUMBER(3) NOT NULL UNIQUE,
	...
	(
		...
		id_Budynku NUMBER(3),
		id_DaneKontaktowe NUMBER(3) UNIQUE
	);
	--- TABELA STANOWISKA
	...
	(
		id_DaneKontaktowe Number(3) PRIMARY KEY,
	...
	--- BUDYNKI WYPEŁNIENIE
	Insert into BUDYNKI (id_BUDYNKU,nazwa_budynku,id_DaneKontaktowe,id_Kierownika)
	...
	---- PRACOWNICY WYPEŁNIENIE
		---KIEROWNICY BUDYNKOW
	Insert into PRACOWNICY (id_Pracownika,nazwisko_Pracownika,haslo,id_Stanowiska,id_Budynku,id_DaneKontaktowe)
	...
	Insert into STANOWISKA (id_Stanowiska,pensja,nazwaStanowiska)
...
INSERT into DANEKONTAKTOWE (id_DaneKontaktowe, kodPocztowy, miast, ulica, numerBudynku, numerTelefonu)
...
values (42, 21465, 'London', 'HelloThere', 4, '547632819');
	...
	Insert into PRODUCENCI (id_Producenta,nazwa_producenta,id_DaneKontaktowe)
	...
	---WYPEŁNIENIE KLIENCI
	Insert into KLIENCI(id_Klienta,nazwiskoKlienta,id_DaneKontaktowe)
	...
	FOREIGN KEY (id_DaneKontaktowe) REFERENCES DANEKONTAKTOWE(id_DaneKontaktowe);
